...
public class Ventana_Flota_AfricaNorte {
	...
	public Ventana_Flota_AfricaNorte() {
		ventana = new JFrame("Mercancia Flota África del Norte");
	...
	public void colocarEtiquetas() {
		etiqueta1 = new JLabel("Mercancias de África del Norte");
