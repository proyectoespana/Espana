...
public class Ventana_Principal extends JFrame {
	...
	private void crearPanelMercancias() {
		...
		panelMercancia.setBounds(396, 11, 281, 70);
		...
		ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(source == mntmNewMenuItem) {
					...
					Ventana_Mercancia_NuevaEspanha f5=new Ventana_Mercancia_NuevaEspanha();
				}
		...
		ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(source == mntmNewMenuItem) {
					...
					Ventana_Flota_Peru flota16=new Ventana_Flota_Peru();
				}
				else if(source == mntmNewMenuItem_7) {
					Ventana_Flota_Plata flota17=new Ventana_Flota_Plata();
				}
				else if(source == mntmNewMenuItem_8) {
					Ventana_Mercancia_EuropaEste f9=new Ventana_Mercancia_EuropaEste();
				}
