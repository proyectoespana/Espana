...
public class Ventana_Mercancia_NuevaEspanha {
	...
	public Ventana_Mercancia_NuevaEspanha() {
	...
	public void colocarEtiquetas() {
		etiqueta1 = new JLabel("Maiz ------ 2500 Kg");
		etiqueta1.setBounds(105, 10, 129, 14);
		panel.add(etiqueta1);

		etiqueta2 = new JLabel("Oro ------ 20000 Kg");
		etiqueta2.setBounds(105, 70, 129, 14);
		panel.add(etiqueta2);

		etiqueta3 = new JLabel("Cacao ------ 2500 Kg");
		etiqueta3.setBounds(105, 130, 129, 14);
		panel.add(etiqueta3);

		etiqueta4 = new JLabel("Tomate ------ 2500 Kg");
