...
public class Ventana_Flota_OrienteProximo {
	...
	public Ventana_Flota_OrienteProximo() {
		ventana = new JFrame("Mercancia Flota Oriente Próximo");
	...
	public void colocarEtiquetas() {
		etiqueta1 = new JLabel("Mercancias de Oriente Próximo");
