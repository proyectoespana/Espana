...
public class Castilla extends Europa {
     ...
     * @throws Exception 
     */
	public Castilla(String nombre,String continente, int poblacion,String territorio,IntroducirDatos base) throws Exception {
		super(nombre,continente, poblacion,base,territorio, 621,	2375, 1784, 0, 9020,7258,9123,10927);
