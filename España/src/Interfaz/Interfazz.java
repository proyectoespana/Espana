...
//		panelFlotas.add(lblMontarFlotas);
		...
		JLabel lblNewLabel_1 = new JLabel("Montar flotas");
		lblNewLabel_1.setBounds(10, 3, 104, 14);
		panelFlotas.add(lblNewLabel_1);
...
//		panelAragonMercancia.add(lblMercanciaDisponibleAragn);
		...
		JLabel lblMercanciaDisponibleAragn = new JLabel("Mercancia disponible Arag\u00F3n");
		lblMercanciaDisponibleAragn.setBounds(10, 11, 170, 14);
		panelAragonMercancia.add(lblMercanciaDisponibleAragn);
