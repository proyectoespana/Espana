...
public class Ventana_Flota_NuevaEspaña {
	...
	public Ventana_Flota_NuevaEspaña(PanelControl control) {
		this.control=control;
		ventana = new JFrame("Mercancia Flota Nueva España");
	...
	public void colocarEtiquetas() {
		etiqueta1 = new JLabel("Mercancias de Nueva España");
		etiqueta2 = new JLabel("Mercancias");
		etiqueta3 = new JLabel("~~~~~~~~~~~~~~");
		etiqueta4 = new JLabel("Destino");

		etiqueta1.setBounds(315, -25, 200, 100);
	...
	public void colocarBox() {
		...
		Iterator it=this.control.getEspana().getNuevaEspaña().getFlota().getArrayMercancias().keySet().iterator();
		...
		while(it.hasNext()) {
			...
			jmenuitem = new JMenuItem(id+" "+this.control.getEspana().getNuevaEspaña().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getNuevaEspaña().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ");
	...
	public void colocarBoton() {
		...
		ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(control.getEspana().getNuevaEspaña().getFlota().getArrayMercancias().size()!=0) {
					try {
						switch (box2.getSelectedItem().toString().toUpperCase()) {
						case "ARAGON":
							control.getEspana().enviarFlota(control.getEspana().getNuevaEspaña(), control.getEspana().getAragon());
							System.out.println("Importaciones Aragón");
							control.getEspana().getAragon().verMercanciasImportacion();
							break;
						case "NUEVA GRANADA": 
							control.getEspana().enviarFlota(control.getEspana().getNuevaEspaña(), control.getEspana().getNuevaGranda());
							System.out.println("Importaciones Nueva Granada");
							control.getEspana().getNuevaGranda().verMercanciasImportacion();
							break;
						case "PERU":
							control.getEspana().enviarFlota(control.getEspana().getNuevaEspaña(), control.getEspana().getPeru());
							System.out.println("Importaciones Peru");
							control.getEspana().getPeru().verMercanciasImportacion();
							break;
						case "PLATA": 
							control.getEspana().enviarFlota(control.getEspana().getNuevaEspaña(), control.getEspana().getPlata());
							System.out.println("Importaciones Plata");
							control.getEspana().getPlata().verMercanciasImportacion();
							break;
						case "CASTILLA":
							control.getEspana().enviarFlota(control.getEspana().getNuevaEspaña(), control.getEspana().getCastilla());
							System.out.println("Importaciones Castilla");
							control.getEspana().getCastilla().verMercanciasImportacion();
							break;
						case "AUSTRIA":
							control.getEspana().enviarFlota(control.getEspana().getNuevaEspaña(), control.getEspana().getAustria());
							System.out.println("Importaciones Austria ");
							control.getEspana().getAustria().verMercanciasImportacion();
							break;
						case "BORGOÑA":
							control.getEspana().enviarFlota(control.getEspana().getNuevaEspaña(), control.getEspana().getBorgoña());
						...
						System.out.println("Mercancias Reino Nueva España");
						control.getEspana().getNuevaEspaña().verMercancias();
						System.out.println("Mercancias FLota Nueva España");
