...
public class Ventana_Flota_Aragon {
	...
	public Ventana_Flota_Aragon(PanelControl control) {
	...
	public void colocarEtiquetas() {
		etiqueta1 = new JLabel("Mercancias de Aragón");
	...
	public void colocarBox() {
		...
		while(it.hasNext()) {
			...
			jmenuitem = new JMenuItem(id+" "+this.control.getEspana().getAragon().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getAragon().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(control.getEspana().getAragon().getFlota().getArrayMercancias().size()!=0) {
					try {
						...
						case "NUEVA ESPAÑA":
							control.getEspana().enviarFlota(control.getEspana().getAragon(), control.getEspana().getNuevaEspaña());
						...
						case "AUSTRIA":
							...
							break;
						case "BORGOÑA":
							control.getEspana().enviarFlota(control.getEspana().getAragon(), control.getEspana().getBorgoña());
						...
						System.out.println("Mercancias Reino Aragon");
						control.getEspana().getAragon().verMercancias();
						System.out.println("Mercancias FLota Aragon");
