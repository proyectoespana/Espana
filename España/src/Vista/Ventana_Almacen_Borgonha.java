...
public class Ventana_Almacen_Borgonha {
	...
	public void colocarEtiquetas() {
		...
		etiqueta2 = new JLabel("Peso disponible : "+String.valueOf(this.control.getEspana().getBorgoña().getFlota().getPesoTodasMercancias()));
		etiqueta2.setBounds(60, 200, 200, 14);
		panel.add(etiqueta2);

		//Peso restante de la flota
		etiqueta3 = new JLabel("Peso total introducido: "+String.valueOf(this.control.getEspana().getBorgoña().getFlota().getPesoMaximo()-this.control.getEspana().getBorgoña().getFlota().getPesoTodasMercancias()));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(id!=-1) {
					...
					try {
						...
						etiqueta2.setText("Peso disponible : "+String.valueOf(control.getEspana().getBorgoña().getFlota().getPesoTodasMercancias()));
						etiqueta3.setText("Peso total introducido: "+String.valueOf(control.getEspana().getBorgoña().getFlota().getPesoMaximo()-control.getEspana().getBorgoña().getFlota().getPesoTodasMercancias()));
