...
public class Ventana_Flota_Peru {
	...
	public Ventana_Flota_Peru(PanelControl control) {
	...
	public void colocarEtiquetas() {
		etiqueta1 = new JLabel("Mercancias de Perú");
	...
	public void colocarBox() {
		...
		while(it.hasNext()) {
			...
			jmenuitem = new JMenuItem(id+" "+this.control.getEspana().getPeru().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getPeru().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ");
				...
				if(control.getEspana().getPeru().getFlota().getArrayMercancias().size()!=0) {
					try {
						...
						case "NUEVA GRANADA": 
							...
							break;
						case "NUEVA ESPAÑA":
							control.getEspana().enviarFlota(control.getEspana().getPeru(), control.getEspana().getNuevaEspaña());
						...
						case "AUSTRIA":
							...
							break;
						case "BORGOÑA":
							control.getEspana().enviarFlota(control.getEspana().getPeru(), control.getEspana().getBorgoña());
						...
						System.out.println("Mercancias Reino Perú");
						control.getEspana().getPeru().verMercancias();
						System.out.println("Mercancias FLota Perú");
