...
public class Ventana_Flota_Borgonha {
	...
	public Ventana_Flota_Borgonha(PanelControl control) {
				...
				if(control.getEspana().getBorgoña().getFlota().getArrayMercancias().size()!=0) {
					try {
						...
						case "AUSTRIA":
							...
							break;
						case "ARAGON":
							control.getEspana().enviarFlota(control.getEspana().getBorgoña(), control.getEspana().getAragon());
							System.out.println("Importaciones Aragón");
							control.getEspana().getAragon().verMercanciasImportacion();
							break;
						case "CASTILLA":
							control.getEspana().enviarFlota(control.getEspana().getBorgoña(), control.getEspana().getCastilla());
