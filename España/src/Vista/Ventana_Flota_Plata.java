...
public class Ventana_Flota_Plata {
	...
	public Ventana_Flota_Plata(PanelControl control) {
	...
	public void colocarEtiquetas() {
		etiqueta1 = new JLabel("Mercancias de Plata");
	...
	public void colocarBox() {
		...
		Iterator it=this.control.getEspana().getPlata().getFlota().getArrayMercancias().keySet().iterator();
		...
		while(it.hasNext()) {
			...
			jmenuitem = new JMenuItem(id+" "+this.control.getEspana().getPlata().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getPlata().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ");
	...
	public void colocarBoton() {
		...
		ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(control.getEspana().getPlata().getFlota().getArrayMercancias().size()!=0) {
					try {
						switch (box2.getSelectedItem().toString().toUpperCase()) {
						case "ARAGON":
							control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getAragon());
							System.out.println("Importaciones Aragón");
							control.getEspana().getAragon().verMercanciasImportacion();
							break;
						case "NUEVA GRANADA": 
							control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getNuevaGranda());
							System.out.println("Importaciones Nueva Granada");
							control.getEspana().getNuevaGranda().verMercanciasImportacion();
							break;
						case "NUEVA ESPAÑA":
							control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getNuevaEspaña());
							System.out.println("Importaciones Nueva España");
							control.getEspana().getNuevaEspaña().verMercanciasImportacion();
							break;
						case "PERU": 
							control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getPeru());
							System.out.println("Importaciones Perú");
							control.getEspana().getPeru().verMercanciasImportacion();
							break;
						case "CASTILLA":
							control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getCastilla());
							System.out.println("Importaciones Castilla");
							control.getEspana().getCastilla().verMercanciasImportacion();
							break;
						case "AUSTRIA":
							control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getAustria());
							System.out.println("Importaciones Austria ");
							control.getEspana().getAustria().verMercanciasImportacion();
							break;
						case "BORGOÑA":
							control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getBorgoña());
						...
						System.out.println("Mercancias Reino Plata");
						control.getEspana().getPlata().verMercancias();
						System.out.println("Mercancias FLota Plata");
